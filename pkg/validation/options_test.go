...
func TestNewOptions(t *testing.T) {
	...
	expected := errorMsg([]string{
		...
		"provider  missing setting: client-secret or client-secret-file"})
...
func TestClientSecretFileOptionFails(t *testing.T) {
	...
	p := o.GetProviders()[providerID].Data()
...
func TestGoogleGroupOptions(t *testing.T) {
	...
	expected := errorMsg([]string{
		"providerID provider missing setting: google-admin-email",
		"providerID provider missing setting: google-service-account-json"})
	assert.Equal(t, expected, err.Error())
}
...
func TestSkipOIDCDiscovery(t *testing.T) {
	...
	assert.Equal(t, "invalid configuration:\n"+
		"  providerID provider missing setting: login-url\n  providerID provider missing setting: redeem-url\n  providerID provider missing setting: oidc-jwks-url", err.Error())
